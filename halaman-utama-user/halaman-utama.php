      ...
      <div class="container-fluid mb-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link fw-bold fs-5" href="./hasil-admin/course/course-admin1-user.php">Course</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-bold fs-5" href="./hasil-admin/mentor/halaman-mentor-admin1-user.php">Menthor</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="#">Hello Alhafiqi hafizi</a></li>
                <li><a class="dropdown-item" href="./edit-profile/edit-data-user.php">Profil</a></li>
                <!-- edit profile -->
                <!-- edit profile -->
