      ...
      <div class="container-fluid mb-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link fw-bold fs-5" href="../mentor/halaman-mentor-admin1-user.php">Mentor</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="../../edit-profile/edit-data-user.php">profile</a></li>
    ...
    <div id="carouselExampleIndicators" class="carousel slide mt-5" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="asset/foto4.jpg" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="asset/foto2.jpg" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="asset/foto1.jpg" class="d-block w-100" alt="Slide 3">
        </div>
        <div class="carousel-item">
          <img src="asset/foto3.jpg" class="d-block w-100" alt="Slide 4">
        </div>
      </div>
...
<div class="container mt-5 page-frame  ">
  <h2 class="text-center d-flex justify-content-center align-items-center me-5">MENTOR DI AEZAQ COURSE</h2>

  <div class="row mt-3 text-center" id="cardContainer" style="overflow-x: auto; white-space: nowrap;">
    <?php include 'tampil-mentor-USER.php'; ?>
  </div>
