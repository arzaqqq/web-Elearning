...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Data pengguna berhasil diperbarui.'); window.location.href = 'course-admin1.php';</script>";
    } else {
...
<body>
    <div class="container ">
        <div class="card text-center">
            <div class="card-body">
                <h2 class="card-title">Edit Data Course</h2>
