...
<div class="container mt-5 page-frame  ">
  ...
  <div class="row mt-3 text-center" id="cardContainer" style="overflow-x: auto; white-space: nowrap;">
    <?php include 'tampil-course.php'; ?>
  </div>

  <button class="btn btn-primary text-light" onclick="addCard()"><a class="text-white" style="text-decoration: none;" href="isi-course.php">Tambah</a></button>
