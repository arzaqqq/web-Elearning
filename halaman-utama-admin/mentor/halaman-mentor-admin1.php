...
<div class="container mt-5 page-frame  ">
  ...
  <div class="row mt-3 text-center" id="cardContainer" style="overflow-x: auto; white-space: nowrap;">
    <?php include 'tampil-mentor.php'; ?>
  </div>

  <button class="btn btn-primary text-light" onclick="addCard()"><a class="text-white" style="text-decoration: none;" href="isi-mentor.php">Tambah</a></button>
</div>
</div>
